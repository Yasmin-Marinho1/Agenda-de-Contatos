...
/**********************************************************
 * IFPB - Curso de Bacharelado em Eng. de Software
 * POO - Prof. Fausto Ayres
 **********************************************************/
...
public class GeradorID {
	...
	public static void ativar(ObjectContainer manager) {
		if (manager == null)
			throw new RuntimeException("Não pode ativar GeradorID - manager desconectado"); // desativado
